...
const purgedCssBase = pathModule.resolve("output/build/css/purged")
const deployBundlesBase = pathModule.resolve("output/build/bundles/deploy")
const includesPath = pathModule.resolve("output/build/includes")
